...
def updateEventsList(window, widget):
    ...
    session.download_file('7c473f40d7862735', 'csv')
    session.download_file('k2dimntt23gm0b7t', 'csv')
    session.download_file('ZW5TFERBT8B0GMQ', 'csv')
    ...
    os.remove('7c473f40d7862735.csv')
    os.remove('k2dimntt23gm0b7t.csv')
    os.remove('ZW5TFERBT8B0GMQ.csv')
