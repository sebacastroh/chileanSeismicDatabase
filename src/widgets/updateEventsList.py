...
def updateEventsList(window, widget, basePath, dataPath):
    ...
    session.download_file('7c473f40d7862735', 'csv', filename = os.path.join(basePath, 'tmp', '7c473f40d7862735.csv'))
    session.download_file('k2dimntt23gm0b7t', 'csv', filename = os.path.join(basePath, 'tmp', 'k2dimntt23gm0b7t.csv'))
    session.download_file('ZW5TFERBT8B0GMQ' , 'csv', filename = os.path.join(basePath, 'tmp', 'ZW5TFERBT8B0GMQ.csv'))

    df1 = pd.read_csv(os.path.join(basePath, 'tmp', '7c473f40d7862735.csv'), dtype={'Identificador': str}) # 1985
    df2 = pd.read_csv(os.path.join(basePath, 'tmp', 'k2dimntt23gm0b7t.csv'), dtype={'Identificador': str}) # 1994 a 2010
    df3 = pd.read_csv(os.path.join(basePath, 'tmp', 'ZW5TFERBT8B0GMQ.csv') , dtype={'Identificador': str}) # 2012 a la fecha
    ...
    os.remove(os.path.join(basePath, 'tmp', '7c473f40d7862735.csv'))
    os.remove(os.path.join(basePath, 'tmp', 'k2dimntt23gm0b7t.csv'))
    os.remove(os.path.join(basePath, 'tmp', 'ZW5TFERBT8B0GMQ.csv'))
